...
angular.module('ds.datepicker', ["dateParser"]), function () {
    ...
    angular.module('ds.datepicker').directive('dsDatepicker', ["$document","$log","dsDatepickerService","$locale",function(e,t,n,r){return{restrict:"EA",require:"^ngModel",controller:"dsDatepickerCtrl",scope:{date:"=?ngModel",config:"=?"},link:function(e,t,r,a){function i(t){var r;r=new Date(t),e.currentDate&&r.getMonth()==e.currentDate.getMonth()||(e.dates=n.generateDateArray(new Date(t))),e.currentDate=r}e.disabled=!1,e.dates=[],e.currentDate=void 0,e.setDate=function(e){a.$setViewValue(e)},e.addDate=function(){a.$setViewValue(new Date(n.increaseDate(e.date)))},e.subDate=function(){a.$setViewValue(new Date(n.decreaseDate(e.date)))},e.addMonth=function(){a.$setViewValue(new Date(n.increaseMonth(e.date)))},e.subMonth=function(){a.$setViewValue(new Date(n.decreaseMonth(e.date)))},function(){a.$formatters.push(function(e){return i(e),e}),a.$parsers.push(function(e){return i(e),e}),angular.element(t[0].querySelector(".datepicker-inputField")).bind("keydown",function(t){38===t.keyCode?e.addDate():40===t.keyCode&&e.subDate(),e.$apply()}),r.$observe("disabled",function(t){e.disabled=t})}()},templateUrl:"src/templates/dsDatepicker.tpl.html"}}]);
}(), function () {
    ...
    angular.module('ds.datepicker').controller('dsDatepickerCtrl', ["$scope","$document","$log",function(e,t,n){var r;e.pickerState=!1,e.flipPickerState=function(t){e.pickerState?e.disablePicker(t):e.enablePicker(t)},e.enablePicker=function(n){if(e.pickerState=!0,!r){var a=!1;r=function(){a?(e.disablePicker(),e.$digest()):a=!0},t.on("click",r)}},e.disablePicker=function(){e.pickerState=!1,r&&(t.off("click",r),r=void 0)}}]);
}();